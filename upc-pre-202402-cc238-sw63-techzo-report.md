...
A continuación presentaremos los commits realizados en el repositorio de nuestro backend, todos estos commits se han hecho en ramas donde cada una representa una Technical Story durante el desarrollo de nuestro Sprint 1.
...
A continuación presentaremos los commits que se han hecho en la rama “feature/backend/sprint-1” de nuestro repositorio, en el cual hemos seguido el esquema Gherkin y añadimos los archivos .feature de nuestro Sprint 1.
...
En la siguiente fase, decidimos utilizar las funciones colaborativas de GitHub, lo cual fue crucial para la cooperación entre todos los participantes. Esto resultó en una implementación eficiente y sin complicaciones. Al permitir que cada integrante tuviera acceso al repositorio, se realizaron los commits de manera fluida y rápida, lo que permitió que todos pudieran visualizar los cambios y el progreso realizado.
...
| GutoPin | Pin Matallana, Augusto Jose |
